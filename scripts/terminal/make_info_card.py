...
TITLE = "xavrir@github ~ $ neofetch"
ROWS = [
    ("", ""),
    ("Name", "Rizky / Xavrir"),
    ("Role", "Software Engineer"),
    ("Study", "BINUS University"),
    ("", ""),
    ("Built", "TuxTuner / Masjid Display"),
    ("Also", "LuhutOS / FreshTrack"),
    ("", ""),
    ("Stack", "Rust / TypeScript / Go / Python"),
    ("Focus", "Systems / apps / open source"),
    ("", ""),
    ("Profile", "github.com/Xavrir"),
]
